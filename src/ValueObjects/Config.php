...
class Config
{
    ...
    public static function fromArray(array $array): self
    {
        ...
        if (isset($array['generatorOptions']) && is_string($array['generatorOptions']) && is_a(GeneratorOptions::class, Enum::class, true)) {
            $array['generatorOptions'] = GeneratorOptions::fromName($array['generatorOptions']);
        }

        if (isset($array['generatorOptions']) && is_array($array['generatorOptions']) ){
            $array['generatorOptions'] = GeneratorOptions::fromArray($array['generatorOptions']);
        }

        return new self(
            $array['generatorOptions'] ?? null
        );
    }
